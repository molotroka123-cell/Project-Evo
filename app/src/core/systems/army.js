...
// Переводит табличные «+7 эффективной силы» в множитель. 90 подобрано стендом
// (200 боёв на пару): контр-юнит выигрывает 60–75%, а не 95% и не 52%.
export const COUNTER_DIVISOR = 90;
export const HILL_RANGE_MULT = 1.25;   // U21: стрелки с холма
